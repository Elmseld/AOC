<div class='comment-form'>
    <form method=post>
        <input type=hidden name="redirect" value="<?=$pagekey == 'forum' ? $this->url->create('forum') : $this->url->create('')?>">
        ...
        <p class=buttons>
            ...
            <input type='submit' name='doGoBack' value='Avbryt' onClick="this.form.action = '<?=$pagekey == 'forum' ? $this->url->create('forum') : $this->url->create('')?>'">
        </p>
        <output></output>
        </fieldset>
    </form>
