 ...
 *
 */
class EFormUpdateUser extends \Mos\HTMLForm\CForm
{
    ...
    public function callbackSubmit()
    {
        ...
        $this->di->msgFlash->success('<p><span class="flashmsgicon"><i class="fa fa-check-circle fa-2x"></i></span>&nbsp;Användaren '.$this->Value('acronym').' uppdaterades!</p>');
        return true;
    }
