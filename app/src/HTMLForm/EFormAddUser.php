 ...
 *
 */
class EFormAddUser extends \Mos\HTMLForm\CForm
{
    ...
    public function callbackSubmit()
    {
        ...
        if ($userExists) {
            ...
            $this->di->msgFlash->alert('<p><span class="flashmsgicon"><i class="fa fa-exclamation-circle fa-2x"></i></span>&nbsp;Användarnamnet '.$this->Value('acronym').' är upptaget!</p>');
        ...
        if ($emailExists) {
            $this->di->session->set('tempuser', $tempuser);
            $this->di->msgFlash->alert('<p><span class="flashmsgicon"><i class="fa fa-exclamation-circle fa-2x"></i></span>&nbsp;Det finns redan en användare med mailadressen '.$this->Value('email').' registrerad!</p>');
            $this->redirectTo('users/add');
        }
        ...
        if ($this->Value('password') !== $this->Value('repeat_password')) {
            $this->di->session->set('tempuser', $tempuser);
            $this->di->msgFlash->alert('<p><span class="flashmsgicon"><i class="fa fa-exclamation-circle fa-2x"></i></span>&nbsp;Lösenorden matchar inte.</p>');
            $this->redirectTo('users/add');
        }
        ...
        $this->di->session->set('tempuser', null);  // clear tempuser info
        $this->di->msgFlash->success('<p><span class="flashmsgicon"><i class="fa fa-check-circle fa-2x"></i></span>&nbsp;Användaren '.$this->Value('acronym').' är registrerad!</p>');
        return true;
    }
